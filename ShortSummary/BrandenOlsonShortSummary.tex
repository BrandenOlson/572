...
Baudry et al. introduce a routine that allows for the number of clusters and mixtures to differ by minimizing entropy.
The method is shown to successfully identify particular cell subpopulations in patients.
